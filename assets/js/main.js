			...
			$(window).load(function() {
				...
				$(function() {
					...
					$( document ).ready(function() {
						...
						$('#portfolio-item-filter a').removeClass('active');
						
						// add active class to default filter
						$('#portfolio-item-filter a[data-filter="' + default_selection + '"]').addClass('active');
					
						// filter items using the default
						var filterValue = default_selection;
						filterValue = filterFns[ filterValue ] || filterValue;
						$container.isotope({ filter: filterValue });
